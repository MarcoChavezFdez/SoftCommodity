 ...
 *
 * Esta clase es la encargada generar la interface y manejar el corte del
 * usuario ,aademas contiene los eventos necesarios para que el usuario
 * interactue con el sistema
 *
 */
package GUI;
